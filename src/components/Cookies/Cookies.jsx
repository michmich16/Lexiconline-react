...
export const Cookies = () => {
    ...
    return (
        <>
            <div id="Cookie_container" className={style.modal}>
                    ...
                    <button className={style.Cookie_button_accepted} onClick={handleAccept}>Accept</button>
                    <button className={style.Cookie_button_rejected} onClick={handleDeny}>Reject</button>
            </div>
        </>
    );
};
